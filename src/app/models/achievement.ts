...
export const ALL_ACHIEVEMENTS: Achievement[] = [
  ...
  { id: 'lost_1',       title: 'First Milestone',  description: 'Lose 1 kg/lbs toward your goal',            icon: 'trending_down',  xp: 50,  rarity: 'common',    unlocked: false },
  { id: 'lost_5',       title: 'Making Progress',  description: 'Lose 5 kg/lbs toward your goal',            icon: 'moving',         xp: 100, rarity: 'rare',      unlocked: false },
  { id: 'lost_10',      title: 'Transformation',   description: 'Lose 10 kg/lbs toward your goal',           icon: 'emoji_events',   xp: 200, rarity: 'epic',      unlocked: false },
